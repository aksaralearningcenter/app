...
const KAMUS = {
  ...
  'Aksara Learning Center · Panel Guru': 'Aksara Learning Center · Teacher Panel',
  'Aksara Learning Center · Panel Orang Tua': 'Aksara Learning Center · Parent Panel',
  'Aksara Learning Center · Panel Murid': 'Aksara Learning Center · Student Panel',
  'Guru | Aksara Learning Center': 'Teacher | Aksara Learning Center',
  'Orang Tua | Aksara Learning Center': 'Parent | Aksara Learning Center',
  'Murid | Aksara Learning Center': 'Student | Aksara Learning Center',
  ...
  'Murid': 'Students',
  'Akun & Anak': 'Accounts & Children',
  'Akun Orang Tua': 'Parent Accounts',
  'Akun Murid': 'Student Accounts',
  'Murid Belum Punya Akun': 'Students Without an Account',
  'Belum Punya Akun': 'No Account Yet',
  'Murid Dua Akun': 'Students With Two Accounts',
  'Simpan tautan': 'Save link',
  'Anak Tertaut': 'Linked Children',
  'Tanpa Akun Orang Tua': 'No Parent Account',
  'Anak Tanpa Akun Orang Tua': 'Children Without a Parent Account',
  'Tautkan anak': 'Link a child',
  'Kirim kredensial baru': 'Send new credentials',
  'Kirim kredensial': 'Send credentials',
  'Absensi': 'Attendance',
  'Progres': 'Progress',
  ...
  'Permintaan': 'Requests',
  'Permintaan Jadwal': 'Schedule Requests',
  'Kuota Sesi': 'Session Quota',
  'Jadwal Satu Murid': 'Single Student Schedule',
  'Hari': 'Day',
  'Hari Aktif': 'Active Days',
  'Sesi / Pekan': 'Sessions / Week',
  'Sesi Privat': 'Private Sessions',
  'Kelas Terlayani': 'Classes Served',
  'Peserta': 'Participants',
  'Ruang': 'Room',
  'Semua hari': 'All days',
  'Semua kelas': 'All classes',
  'Semua guru': 'All teachers',
  'Jam mulai *': 'Start time *',
  'Jam selesai': 'End time',
  'Tanggal absensi': 'Attendance date',
  'Riwayat Absensi': 'Attendance History',
  'Diisi oleh': 'Filled by',
  'Seluruh kelas': 'Whole class',
  '-- Pilih Murid --': '-- Select Student --',
  'Tanpa sesi (absensi harian)': 'Without a session (daily attendance)',
  'Kapasitas': 'Capacity',
  'Catatan Jadwal': 'Schedule Note',
  'Sesi Jadwal': 'Schedule Sessions',
  ...
  '👁️ Lihat Jadwal': '👁️ View Schedule',
  '📅 Hari Ini': '📅 Today',
  ...
  'Murid, Kelas, Jadwal, Absensi, Progres, Tabungan, Transaksi.': 'Students, Classes, Schedule, Attendance, Progress, Savings, Transactions.',
  'Mengosongkan': 'Clears',
  'Mengisi': 'Seeds',
  'soal': 'questions',
  'semua': 'all',

...
import { uploadField, dokumenField, badgeBerkas, pratinjauGambar, pratinjauDokumen } from './upload.js';
  ...
  const SETTING_FIELDS = [
    ...
    { k: 'seksi_katalog_judul', label: 'Perpustakaan — Judul', grup: 'Judul & Sub-judul Seksi' },
    { k: 'seksi_katalog_sub', label: 'Perpustakaan — Sub-judul', grup: 'Judul & Sub-judul Seksi', area: true },
